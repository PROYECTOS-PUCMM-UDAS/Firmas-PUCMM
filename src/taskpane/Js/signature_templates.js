...
function get_template_B_str(user_info)
{
  ...
  str +=   "<tr>";
  str +=     "<td style='border-right: 1px solid #000000; padding-right: 5px;'><img src='https://proyectos-pucmm-udas.github.io/Firmas-PUCMM/assets/marca-pucmm.jpg' alt='Logo' /></td>";
